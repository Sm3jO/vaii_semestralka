...
const ReviewsPost: React.FC<ReviewsPostProps> = ({ title, summary, image_url, authorImage, authorName, created_at, readMoreLink }) => {
                ...
                <div className="lg:flex lg:items-center">
                    ...
                    <div className="mt-6 lg:w-1/2 lg:mt-0 lg:mx-6">
                        ...
                        <div className="flex items-center mt-6">
                            ...
                            />
                            <div className="mx-4">
                                <h1 className="text-sm text-gray-500">{authorName}</h1>
